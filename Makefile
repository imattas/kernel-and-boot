...
$(KERNEL_ELF): $(KERNEL_OBJ) $(KERNEL_ENTRY_ASM_OBJ) $(KERNEL_TABLES_OBJ) $(KERNEL_TABLES_ASM_OBJ) $(KERNEL_SERIAL_OBJ) $(KERNEL_CPU_OBJ) $(KERNEL_EXCEPTIONS_OBJ) $(KERNEL_PANIC_OBJ) $(KERNEL_PHYSICAL_OBJ) $(KERNEL_VIRTUAL_OBJ) $(KERNEL_HEAP_OBJ) $(KERNEL_IRQ_OBJ) $(KERNEL_APIC_OBJ) $(KERNEL_ACPI_OBJ) $(KERNEL_PERCPU_OBJ) $(KERNEL_TRAMPOLINE_OBJ) $(KERNEL_TIMER_OBJ) $(KERNEL_TIMER_ASM_OBJ) $(KERNEL_KEYBOARD_ASM_OBJ) $(KERNEL_SYNC_OBJ) $(KERNEL_TASK_OBJ) $(KERNEL_TASK_ASM_OBJ) $(KERNEL_WAIT_OBJ) $(KERNEL_TASK_DESC_OBJ) $(KERNEL_SCHED_OBJ) $(KERNEL_SCHED_POLICY_OBJ) $(KERNEL_PROCESS_OBJ) $(KERNEL_PROCESS_LIFECYCLE_OBJ) $(KERNEL_PROCESS_HANDLE_OBJ) $(KERNEL_PROCESS_THREAD_OBJ) $(KERNEL_EXEC_OBJ) $(KERNEL_SYSCALL_OBJ) $(KERNEL_SYSCALL_ASM_OBJ) $(KERNEL_DEVICE_OBJ) $(KERNEL_PCI_OBJ) $(KERNEL_MEMORY_OBJ) $(KERNEL_STORAGE_OBJ) $(KERNEL_ATA_OBJ) $(KERNEL_IPC_OBJ) $(KERNEL_SECURITY_OBJ) $(KERNEL_VFS_OBJ) $(KERNEL_DEBUG_OBJ) $(KERNEL_VFS_MOUNT_OBJ) $(KERNEL_BLOCK_OBJ) $(KERNEL_CACHE_OBJ) $(KERNEL_CLOCK_OBJ) $(KERNEL_DEVFS_OBJ) $(KERNEL_PROCFS_OBJ) $(KERNEL_SLAB_OBJ) $(KERNEL_FAT12_OBJ) $(KERNEL_FAT12_VFS_OBJ) $(KERNEL_FAT32_OBJ) $(KERNEL_EXFAT_OBJ) $(KERNEL_EXFAT_VFS_OBJ) $(KERNEL_INPUT_OBJ) $(KERNEL_PS2_OBJ) $(KERNEL_FRAMEBUFFER_OBJ) $(KERNEL_BOCHS_VGA_OBJ) $(KERNEL_USB_OBJ) $(KERNEL_AHCI_OBJ) $(KERNEL_UHCI_OBJ) $(KERNEL_NVME_OBJ)
$(KERNEL_ELF): $(KERNEL_PIPE_OBJ)
	$(LD) -m elf_x86_64 -pie -T kernel/arch/x86_64/entry/kernel.ld --build-id=none -o $@ $(KERNEL_ENTRY_ASM_OBJ) $(KERNEL_OBJ) $(KERNEL_TABLES_OBJ) $(KERNEL_TABLES_ASM_OBJ) $(KERNEL_SERIAL_OBJ) $(KERNEL_CPU_OBJ) $(KERNEL_EXCEPTIONS_OBJ) $(KERNEL_PANIC_OBJ) $(KERNEL_PHYSICAL_OBJ) $(KERNEL_VIRTUAL_OBJ) $(KERNEL_HEAP_OBJ) $(KERNEL_IRQ_OBJ) $(KERNEL_APIC_OBJ) $(KERNEL_ACPI_OBJ) $(KERNEL_PERCPU_OBJ) $(KERNEL_TRAMPOLINE_OBJ) $(KERNEL_TIMER_OBJ) $(KERNEL_TIMER_ASM_OBJ) $(KERNEL_KEYBOARD_ASM_OBJ) $(KERNEL_SYNC_OBJ) $(KERNEL_TASK_OBJ) $(KERNEL_TASK_ASM_OBJ) $(KERNEL_WAIT_OBJ) $(KERNEL_TASK_DESC_OBJ) $(KERNEL_SCHED_OBJ) $(KERNEL_SCHED_POLICY_OBJ) $(KERNEL_PROCESS_OBJ) $(KERNEL_PROCESS_LIFECYCLE_OBJ) $(KERNEL_PROCESS_HANDLE_OBJ) $(KERNEL_PROCESS_THREAD_OBJ) $(KERNEL_EXEC_OBJ) $(KERNEL_SYSCALL_OBJ) $(KERNEL_SYSCALL_ASM_OBJ) $(KERNEL_DEVICE_OBJ) $(KERNEL_PCI_OBJ) $(KERNEL_MEMORY_OBJ) $(KERNEL_STORAGE_OBJ) $(KERNEL_ATA_OBJ) $(KERNEL_IPC_OBJ) $(KERNEL_SECURITY_OBJ) $(KERNEL_VFS_OBJ) $(KERNEL_DEBUG_OBJ) $(KERNEL_VFS_MOUNT_OBJ) $(KERNEL_BLOCK_OBJ) $(KERNEL_CACHE_OBJ) $(KERNEL_CLOCK_OBJ) $(KERNEL_DEVFS_OBJ) $(KERNEL_PROCFS_OBJ) $(KERNEL_SLAB_OBJ) $(KERNEL_FAT12_OBJ) $(KERNEL_FAT12_VFS_OBJ) $(KERNEL_FAT32_OBJ) $(KERNEL_EXFAT_OBJ) $(KERNEL_INPUT_OBJ) $(KERNEL_PS2_OBJ) $(KERNEL_FRAMEBUFFER_OBJ) $(KERNEL_BOCHS_VGA_OBJ) $(KERNEL_USB_OBJ) $(KERNEL_AHCI_OBJ) $(KERNEL_UHCI_OBJ) $(KERNEL_NVME_OBJ)
