...
$(KERNEL_WINDOW_MANAGER_OBJ): kernel/drivers/display/window_manager.c kernel/drivers/display/window_manager.h kernel/drivers/display/compositor.h kernel/drivers/display/surface.h | $(BUILD_DIR)/kernel
	$(CC) -target x86_64-pc-none-elf -std=c11 -ffreestanding -fno-builtin -fno-stack-protector -fPIE -fno-plt \
		-mno-red-zone -Wall -Wextra -Werror -O2 -c $< -o $@
