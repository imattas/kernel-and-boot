...
$(KERNEL_OBJ): kernel/arch/x86_64/entry/kernel_entry.c kernel/arch/x86_64/cpu/tables.h kernel/drivers/network/e1000.h | $(BUILD_DIR)/kernel
...
KERNEL_NVME_OBJ := $(KERNEL_NVME_OBJ) $(KERNEL_E1000_OBJ) $(KERNEL_E1000_IRQ_OBJ) $(KERNEL_HID_OBJ) $(KERNEL_EXFAT_VFS_OBJ) $(KERNEL_EXT4_OBJ) $(KERNEL_EXT4_VFS_OBJ) $(KERNEL_XFS_OBJ) $(KERNEL_XFS_VFS_OBJ) $(KERNEL_BTRFS_OBJ) $(KERNEL_BTRFS_DEFLATE_OBJ) $(KERNEL_BTRFS_LZO_OBJ) $(KERNEL_BTRFS_ZSTD_OBJ) $(KERNEL_BTRFS_FSE_OBJ) $(KERNEL_BTRFS_VFS_OBJ)
...
$(KERNEL_IPC_OBJ): kernel/ipc/channel.c kernel/ipc/channel.h kernel/core/sync/spinlock.h | $(BUILD_DIR)/kernel
	$(CC) -target x86_64-pc-none-elf -std=c11 -ffreestanding -fno-builtin -fno-stack-protector -fPIE -fno-plt \
		-mno-red-zone -Wall -Wextra -Werror -O2 -c $< -o $@
...
$(KERNEL_UHCI_OBJ): kernel/drivers/usb/uhci.c kernel/drivers/usb/uhci.h kernel/device/device.h kernel/drivers/pci/pci.h kernel/mm/physical/frame.h | $(BUILD_DIR)/kernel
	$(CC) -target x86_64-pc-none-elf -std=c11 -ffreestanding -fno-builtin -fno-stack-protector -fPIE -fno-plt \
		-mno-red-zone -Wall -Wextra -Werror -O2 -c $< -o $@
...
$(BUILD_DIR)/kernel/nvme.o: kernel/drivers/nvme/nvme.c kernel/drivers/nvme/nvme.h kernel/device/device.h kernel/drivers/pci/pci.h kernel/mm/physical/frame.h | $(BUILD_DIR)/kernel
	$(CC) -target x86_64-pc-none-elf -std=c11 -ffreestanding -fno-builtin -fno-stack-protector -fPIE -fno-plt \
		-mno-red-zone -Wall -Wextra -Werror -O2 -c $< -o $@
...
$(KERNEL_DEVICE_OBJ): kernel/device/device.c kernel/device/device.h | $(BUILD_DIR)/kernel
	$(CC) -target x86_64-pc-none-elf -std=c11 -ffreestanding -fno-builtin -fno-stack-protector -fPIE -fno-plt \
		-mno-red-zone -Wall -Wextra -Werror -O2 -c $< -o $@
...
$(KERNEL_PROCESS_THREAD_OBJ): kernel/core/process/thread.c kernel/core/process/thread.h kernel/core/process/process.h kernel/core/task/task.h kernel/mm/heap/heap.h | $(BUILD_DIR)/kernel
	$(CC) -target x86_64-pc-none-elf -std=c11 -ffreestanding -fno-builtin -fno-stack-protector -fPIE -fno-plt \
		-mno-red-zone -Wall -Wextra -Werror -O2 -c $< -o $@
...
$(EXT4_TEST): scripts/tests/c/ext4_contract.c kernel/fs/ext4/ext4.c kernel/fs/ext4/ext4.h kernel/drivers/storage/storage.c kernel/drivers/storage/storage.h | $(TEST_DIR)
	$(CC) -std=c11 -Wall -Wextra -Werror -I. -o $@ scripts/tests/c/ext4_contract.c kernel/fs/ext4/ext4.c kernel/drivers/storage/storage.c
