...
KERNEL_DESKTOP_OBJ := $(BUILD_DIR)/kernel/desktop.o
...
$(KERNEL_DESKTOP_OBJ): kernel/drivers/display/desktop.c kernel/drivers/display/desktop.h kernel/drivers/display/display_service.h kernel/drivers/display/window_manager.h | $(BUILD_DIR)/kernel
	$(CC) -target x86_64-pc-none-elf -std=c11 -ffreestanding -fno-builtin -fno-stack-protector -fPIE -fno-plt \
		-mno-red-zone -Wall -Wextra -Werror -O2 -c $< -o $@
