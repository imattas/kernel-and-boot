...
def main():
    if len(sys.argv) != 36:
        raise SystemExit("usage: create_fat_image.py ... <CP.ELF> <HEAD.ELF> <os.img>")
    ...
    if head_chain[-1] >= TOTAL_SECTORS - DATA_START + 2:
