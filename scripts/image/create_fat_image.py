...
def main():
    if len(sys.argv) != 39:
        raise SystemExit("usage: create_fat_image.py ... <CP.ELF> <HEAD.ELF> <WC.ELF> <GREP.ELF> <TEE.ELF> <os.img>")
    ...
    if tee_chain[-1] >= TOTAL_SECTORS - DATA_START + 2:
