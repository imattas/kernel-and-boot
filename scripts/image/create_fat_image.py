...
def main():
    if len(sys.argv) != 52:
        raise SystemExit("usage: create_fat_image.py ... <UNSETENV.ELF> <UPTIME.ELF> <DATE.ELF> <os.img>")
    ...
    if date_chain[-1] >= TOTAL_SECTORS - DATA_START + 2:
