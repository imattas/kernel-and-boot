...
def main():
    if len(sys.argv) != 51:
        raise SystemExit("usage: create_fat_image.py ... <UNSETENV.ELF> <UPTIME.ELF> <os.img>")
    ...
    if uptime_chain[-1] >= TOTAL_SECTORS - DATA_START + 2:
