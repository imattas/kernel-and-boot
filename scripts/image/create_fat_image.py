...
def main():
    if len(sys.argv) != 41:
        raise SystemExit("usage: create_fat_image.py ... <CP.ELF> <HEAD.ELF> <WC.ELF> <GREP.ELF> <TEE.ELF> <TAIL.ELF> <SORT.ELF> <os.img>")
    ...
    if sort_chain[-1] >= TOTAL_SECTORS - DATA_START + 2:
