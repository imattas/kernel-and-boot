...
def main():
    if len(sys.argv) != 55:
        raise SystemExit("usage: create_fat_image.py ... <UNSETENV.ELF> <UPTIME.ELF> <DATE.ELF> <CLEAR.ELF> <SEQ.ELF> <os.img>")
    ...
    if seq_chain[-1] >= TOTAL_SECTORS - DATA_START + 2:
