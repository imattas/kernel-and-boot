...
def main():
    if len(sys.argv) != 37:
        raise SystemExit("usage: create_fat_image.py ... <CP.ELF> <HEAD.ELF> <WC.ELF> <os.img>")
    ...
    if wc_chain[-1] >= TOTAL_SECTORS - DATA_START + 2:
