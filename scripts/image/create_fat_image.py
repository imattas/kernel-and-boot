...
def main():
    if len(sys.argv) != 38:
        raise SystemExit("usage: create_fat_image.py ... <CP.ELF> <HEAD.ELF> <WC.ELF> <GREP.ELF> <os.img>")
    ...
    if grep_chain[-1] >= TOTAL_SECTORS - DATA_START + 2:
