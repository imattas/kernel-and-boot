...
void shell_main(void) {
    ...
    static const char help[] = "help clear id ps env setenv unsetenv status true false jobs history fg which inherit echo printf basename pwd cd ls cat head wc grep tee tail sort uniq stat chmod kill sleep mv cp mkdir rm rmdir touch write run wait exit\r\n";
