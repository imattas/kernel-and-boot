...
void shell_main(void) {
    ...
    static const char help[] = "help clear id ps env setenv unsetenv status true false jobs history fg which inherit echo pwd cd ls cat head stat chmod kill sleep mv cp mkdir rm rmdir touch write run wait exit\r\n";
